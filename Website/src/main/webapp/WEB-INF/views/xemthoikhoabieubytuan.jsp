					...
					<div class="panel panel-success">
						<div class="panel-heading">
							<center>Thời khóa biểu - Học kỳ: ${sessionScope.hocky }
								- Năm học: ${sessionScope.namhoc } - Tuần: ${tuan } - Ngày bắt
								đầu: ${ngay }</center>
						</div>
						<div class="panel-body">
							<table class="table table-bordered table-hover">
								<thead>
									<tr bgcolor="#99B2E6">
										<th width="40" bgcolor="#99B2E6"><center>Thứ</center></th>
										<th width="120"><center>Mã học phần</center></th>
										<th width="150"><center>Mã lớp học phần</center></th>
										<th>Tên học phần</th>
										<th width="120"><center>Tiết học</center></th>
										<th width="120"><center>Phòng học</center></th>
									</tr>
								</thead>
								<c:forEach var="i" items="${thu2 }">
									<tr bgcolor="#E0FFF0">
										<td bgcolor="#99B2E6"><center>2</center></td>
										<td><center>${i.mahocphan }</center></td>
										<td><center>${i.malophocphan }</center></td>
										<td>${i.tenhocphan }</td>
										<td><center>
										...
										<td><center>
												<c:forEach var="j3" items="${i.dothoc }">
													<c:forEach var="j4" items="${j3.buoi }">
														<c:if test="${j4.thu == '2' }">
														${j4.phong }
													</c:if>
													</c:forEach>
								...
								<c:forEach var="i" items="${thu3 }">
									<tr>
										<td bgcolor="#99B2E6"><center>3</center></td>
										<td><center>${i.mahocphan }</center></td>
										<td><center>${i.malophocphan }</center></td>
										<td>${i.tenhocphan }</td>
										<td><center>
								...
								<c:forEach var="i" items="${thu4 }">
									<tr bgcolor="#E0FFF0">
										<td bgcolor="#99B2E6"><center>4</center></td>
										<td><center>${i.mahocphan }</center></td>
										<td><center>${i.malophocphan }</center></td>
										<td>${i.tenhocphan }</td>
										<td><center>
								...
								<c:forEach var="i" items="${thu5 }">
									<tr>
										<td bgcolor="#99B2E6"><center>5</center></td>
										<td><center>${i.mahocphan }</center></td>
										<td><center>${i.malophocphan }</center></td>
										<td>${i.tenhocphan }</td>
										<td><center>
								...
								<c:forEach var="i" items="${thu6 }">
									<tr bgcolor="#E0FFF0">
										<td bgcolor="#99B2E6"><center>6</center></td>
										<td><center>${i.mahocphan }</center></td>
										<td><center>${i.malophocphan }</center></td>
										<td>${i.tenhocphan }</td>
										<td><center>
								...
								<c:forEach var="i" items="${thu7 }">
									<tr>
										<td bgcolor="#99B2E6"><center>7</center></td>
										<td><center>${i.mahocphan }</center></td>
										<td><center>${i.malophocphan }</center></td>
										<td>${i.tenhocphan }</td>
										<td><center>
